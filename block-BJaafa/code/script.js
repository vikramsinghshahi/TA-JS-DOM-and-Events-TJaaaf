...
document.querySelectorAll('.shortcut-row').forEach((tr) => {
    const info = {}
    const tdCollection = tr.querySelectorAll('td');
    info.description = tdCollection[1].textContent;
    info.cmd = tdCollection[0].textContent;
    result.push(info)
})*/